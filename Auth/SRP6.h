...
class SRP6_SERVER
{
    public:
        ...
        */
        bool CalculateSessionKey(uint8_t* lp_A, int l);
        ...
        */
        bool CalculateVerifier(std::string& name, std::string& password);
        ...
        /*!
          ...
          \return true on success otherwise false if s is faulty
        */
        bool CalculateVerifier(const char* rI, const char* salt);
